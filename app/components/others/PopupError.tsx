...
interface props {
  errors: string;
  setErrors: Dispatch<SetStateAction<null | string>>;
}
  ...
  return (
    <div className="fixed top-0 left-0 flex min-w-full min-h-screen justify-center items-center z-10 px-4">
      <motion.div
        ...
        animate="open"
        variants={inner1}
        className="relative p-8 rounded-3xl w-fit sm:w-35r flex flex-col overflow-hidden dark:bg-gradient-to-tl dark:from-[#08203e] dark:to-[#557c93] dark:shadow-[#08203e] dark:text-slate-300 bg-gradient-to-br from-[#d3f3f1] to-[#43c197] text-slate-700 shadow-2xl shadow-[#d3f3f1]"
      >
        <motion.div variants={outerVariants} initial="closed" animate="open">
          ...
          <motion.h1
            ...
            className="mt-8 font-comicNeue text-xl md:text-2xl font-normal"
          ...
          <motion.h2
            variants={innerVariants}
            className="mt-6 font-ubuntu font-bold text-xl"
            style={lato.style}
          >

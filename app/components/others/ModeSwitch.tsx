  ...
  if (resolvedTheme === "dark") {
    return (
      <div
        ...
        className="bg-slate-900/70 shadow-md shadow-black p-2 rounded-lg flex justify-center items-center cursor-pointer"
      >
  ...
  if (resolvedTheme === "light") {
    return (
      <div
        ...
        className="bg-slate-200/50 shadow-md shadow-gray-700 p-2 rounded-lg flex justify-center items-center cursor-pointer"
      >
        <p className="capitalize mr-3 font-semibold">{`${resolvedTheme} mode`}</p>
        <DarkModeSwitch
          checked={false}

    ...
    <main className="relative text-gray-800 dark:text-gray-300">
      <div className="flex min-w-full min-h-screen justify-center items-center px-4">
        <motion.div
          ...
          animate="open"
          variants={inner1}
          className="relative p-8 rounded-3xl w-fit sm:w-35r flex flex-col overflow-hidden bg-transparent backdrop-blur-sm shadow-2xl bg-slate-200 dark:bg-slate-800 dark:shadow-slate-900 shadow-slate-300"
        >
          <motion.div variants={outerVariants} initial="closed" animate="open">
            ...
            <motion.div
              ...
              className="mt-8 bg-slate-200 dark:bg-slate-900 rounded-md overflow-hidden"
            ...
            >
              ...
              <div className="p-2 text-sm flex flex-col">
                <p>
                  ...
                  <span>: </span>
                  <span style={lato.style} className="">
                    {error.message}
                  </span>
                </p>
                <p className="mt-2">
                  &gt; Unexpected error occurred. Wait sometime or report to the
                  developer.
                </p>
              </div>
            </motion.div>

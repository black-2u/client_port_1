...
const Web = ({ web }: { web: ProjectType[] }) => {
  return (
    <section
      id="WebProjects"
      className="relative overflow-hidden myContainer py-[5rem]"
    >
      <motion.div
        initial="closed"
        whileInView="open"
      ...
      >
        ...
        <div>
          {web && (
            <div className="mt-10 px-4 xl:px-8 mx-auto grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-16">
              {web.map((item, index) => {

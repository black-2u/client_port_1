...
export const projects = [
  ...
  {
    id: "3",
    title: "Way-Finding Optimization",
    overview:
      "Effective AR-based navigation to help users guide themselves better inside shopping complexes. Real-time routing to pave the best possible route and help save the user from extra steps and the crowd.",
    status: "",
    role: "UX Designer",
    tools: ["Adobe XD", "Adobe Illustrator"],
    icons: ["/svg/adobe-xd.svg", "/svg/illustrator.svg"],
    slug: "way_finding_optimization",
    url: "https://www.onboardit.com/",
    thumbnail: "/image/project-3.png",
    images: [
      "/image/image-3-1.png",
      "/image/image-3-2.png",
      "/image/image-3-3.png",
  ...
  {
    id: "4",
    title: "Football and Queue Management",
    overview:
      "Pre-slot Booking with time constraints to manage the inflow and outflow of the crowd coming into the mall. Monitoring the count of  visitors, store, staff, and retail outlet management to avoid congestion and overcrowding",
    status: "",
    role: "UX Designer",
    tools: ["Adobe XD", "Adobe Illustrator"],
    icons: ["/svg/adobe-xd.svg", "/svg/illustrator.svg"],
    slug: "football_and_queue_management",
    url: "https://www.onboardit.com/",
    thumbnail: "/image/project-4.png",
    images: [
      "/image/image-4-1.png",
      "/image/image-4-2.png",
      "/image/image-4-3.png",
  ...
  },
  {
    ...
    tools: ["Adobe XD", "Adobe Illustrator"],
    icons: ["/svg/adobe-xd.svg", "/svg/illustrator.svg"],
    slug: "streamlining_communication",
    url: "https://www.onboardit.com/",
  ...
  {
    id: "6",
    title: "Crowd Surveillance System",
    overview:
    ...
    tools: ["Adobe XD", "Adobe Illustrator"],
    icons: ["/svg/adobe-xd.svg", "/svg/illustrator.svg"],
    slug: "crowd_surveillance_system",
    url: "https://www.onboardit.com/",
    thumbnail: "/image/project-6.png",
    images: ["/image/image-6-1.png"],
  },
];
